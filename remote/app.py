...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://{username}:{password}@{hostname}:3306/{database}'.format( username='janjdev', password='m295Wqe9', hostname='janjdev.mysql.pythonanywhere-services.com', database='janjdev$db' )
app.config['SQLALCHEMY_ECHO'] = True
app.config['SITE_UPLOADS'] = 'static/site/uploads/'
